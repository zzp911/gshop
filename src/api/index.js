...
// 3、根据经纬度获取商铺列表
export const reqShopsLists = (longitude, latitude) => ajax(BASE_URL + '/shops', {longitude, latitude})
// 4、根据经纬度和关键字搜索商铺列表
export const reqSearchShopsLists = (geohash, keyword) => ajax(BASE_URL + '/search_shops', {geohash, keyword})
// 6、用户名密码登陆
