<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="toggleShopMsg">
    ...
    <div class="shop-header-discounts" @click="toggleActivityList" v-if="info.supports">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="shopMsgShow">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="toggleShopMsg">
          <span class="iconfont iconiconclose"></span>
        </div>
      </div>
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="activityListShow">
      <div class="activity-sheet-content">
        ...
        <div class="activity-sheet-close" @click="toggleActivityList">
          <span class="iconfont iconiconclose"></span>
        </div>
      </div>
...
export default {
  ...
  methods: {
    toggleShopMsg () {
      this.shopMsgShow = !this.shopMsgShow
    },
    toggleActivityList () {
      this.activityListShow = !this.activityListShow
    }
  },
  computed: {
    ...mapState(['info'])
